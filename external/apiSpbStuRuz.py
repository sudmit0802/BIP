...
class ApiSpbStuRuz:
    ...
    def __init__(self, try_create_dict=True, proxy=None, timeout=5):
    ...
    async def get_rooms_by_building_id(self, building_id: int):
        """
    ...
    async def get_groups_by_name(self, groups_name: str):
        """
    ...
    async def get_teachers_by_name(self, teachers_name: str):
        """
    ...
    async def get_rooms_by_name(self, rooms_name: str):
        """
