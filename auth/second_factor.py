...
def verify_user(username):
    ...
    if form.validate_on_submit():
        ...
        code_from_db_by_username = get_tfv_code_by_username(username)
        code_drom_db_by_email = get_tfv_code_by_email(username)
        ...
        try:
            ...
            id = id_un or id_em
            if id is None:
                return render_template('signin.html', form=LoginForm(), message = "Что-то пошло не так)")
